...
import EachStoryComponent from './assets/Components/StoriesComponent/EachStoryComponent';
import NavigationBar from './assets/Components/NavigationBar';
import ListOfStories from './assets/Components/StoriesComponent/ListOfStoriesComponent';
    ...
    return (
      ...
      <HashRouter basename='/'>
        ...
        <div>
          ...
          <Route exact path='/stories' component={ListOfStories} />
        </div>
      </HashRouter>
